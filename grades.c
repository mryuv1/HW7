...
void
element_destroy_course (void *element)
{
...
int
clone_course (void *element, void **output)
{
...
int
clone_students (void *element, void **output)
{
...
int
grades_add_student (struct grades *grades, const char *name, int id)
{
  if (grades == NULL)
    {
      return 1;
...
int
grades_add_grade (struct grades *grades, const char *name, int id, int grade)
{
...
float
grades_calc_avg (struct grades *grades, int id, char **out)
{
...
int
grades_print_student (struct grades *grades, int id)
{
  if (grades == NULL)
    {
      return -1;
...
int
grades_print_all (struct grades *grades)
{
  if (grades == NULL)
    {
      return -1;
